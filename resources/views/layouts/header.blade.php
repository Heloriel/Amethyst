<nav class="navbar navbar-expand-lg bg-white py-1">
    <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
            ...
            <div class="navbar-search col-12 my-2 px-2 d-block d-md-none">
                <form class="">
                    <div>
                        <input class="form-control rounded-pill navbar-search" type="search" placeholder="PROCURAR NO SISTEMA ..." aria-label="Search">
                    </div>
        ...
        <div class="dropdown dropdown-menu dropdown-menu-end list-group-flush" id="dropdown" aria-labelledby="dropdownMenuLink">
